...
class SiteInformationForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'd8training_module_site_information_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('d8training_module.site_information');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('d8training_module.site_information')
  ...
  protected function getEditableConfigNames() {
    return [
      'd8training_module.site_information',
    ];
  }
